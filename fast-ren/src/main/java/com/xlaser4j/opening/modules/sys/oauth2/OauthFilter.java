...
import com.xlaser4j.opening.common.util.HttpContextUtils;
...
public class OauthFilter extends AuthenticatingFilter {
    ...
    protected boolean onAccessDenied(ServletRequest req, ServletResponse res) throws Exception {
        ...
        if (StrUtil.isBlank(token)) {
            ...
            JSON apiResponse = JSONUtil.parse(ApiResponse.ofStatus(Status.UNAUTHORIZED));
    ...
    protected boolean onLoginFailure(AuthenticationToken token, AuthenticationException e, ServletRequest request, ServletResponse response) {
        ...
        JSON apiResponse = JSONUtil.parse(ApiResponse.of(Status.UNAUTHORIZED.getCode(), t.getMessage(), null));
        try {
