...
import com.xlaser.opening.common.enums.MenuTypeEnum;
import com.xlaser.opening.modules.sys.entity.SysMenuDO;
import com.xlaser.opening.modules.sys.mapper.SysMenuMapper;
import com.xlaser.opening.modules.sys.service.ISysMenuService;
...
import static com.xlaser.opening.common.constants.ShiroConsts.SUPER_ADMIN;
...
public class SysMenuServiceImpl extends ServiceImpl<SysMenuMapper, SysMenuDO> implements ISysMenuService {
    ...
    public List<SysMenuDO> listMenuByUserId(Long id) {
        ...
        // 管理员权限
        if (ObjectUtil.equal(id, SUPER_ADMIN)) {
